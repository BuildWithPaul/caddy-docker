...
| Open Food Facts API | `/off/` | [BuildWithPaul/openfoodfacts-docker](https://github.com/BuildWithPaul/openfoodfacts-docker) |
...
# 4. Import OFF data (first time only — takes 10-20 min for French dataset)
...
- `https://paul-sandbox.duckdns.org/off/health`
...
└── openfoodfacts-docker/  # OFF API + importer
```
...
- [Open Food Facts Docker](https://github.com/BuildWithPaul/openfoodfacts-docker) — Local OFF API at `/off`
